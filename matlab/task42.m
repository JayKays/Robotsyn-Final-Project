...
% directory.
imageDir = '../hw5_data_ext/';
% imageDir = '../iCloud Photos/';
...
% cameraParams = load('calibratedCameraParams.mat').cameraParams;
...
prevPoints   = detectSURFFeatures(I, 'NumOctaves', 30, 'ROI', roi);
...
for i = 2:n
    ...
    currPoints   = detectSURFFeatures(I, 'NumOctaves', 30, 'ROI', roi);
